...
<head>
  ...
  <title> LASSEN BURGER HAUS </title>
  ...
  <footer class="footer_section">
    <div class="container">
      <div class="row">
        <div class="col-md-4 footer-col">
          <div class="footer_contact">
            <h4>Sucursales</h4>
            {{-- Assuming sucursales-slider is for a JavaScript-based slider --}}
            <div class="sucursales-slider">
              @foreach($aSucursales as $sucursalItem)
              <div class="contact_link_box">
                <span>{{ $sucursalItem->nombre }}</span>
                <span>{{ $sucursalItem->telefono }}</span>
                <span>{{ $sucursalItem->direccion }}</span>
                <a href="{{ $sucursalItem->mapa }}" target="_blank" rel="noopener noreferrer">Ver ubicación en Google Maps</a>
              </div>
              @endforeach
            </div>
          </div>
        ...
        <div class="col-md-4 footer-col">
          <div class="footer_contact">
            ...
            <label>Lunes a Domingo</label>
            <div class="horarios-slider">
              @foreach($aSucursales as $sucursalItem)
              <div>
                <span>- {{ $sucursalItem->nombre }} 18:30 a {{ \Carbon\Carbon::parse($sucursalItem->horario)->format('H:i') }}</span>
              </div>
              @endforeach
            </div>
          </div>
      ...
      <div class="footer-info">
        <p>
          &copy; <span id="displayYear"></span> Trabajo Final
        </p>
      </div>
    </div>
  </footer>
